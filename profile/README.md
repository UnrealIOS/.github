...
Imagine QueenOfAllSeas: (zeppelin/imaginary Air Superiority Fighter/laser guns) preflight, taxing, takeoff, landing, battlestations: pilot, nav, com, atc, hangar, elevator, engine, cannons, radar, fleet control room, Human Team Quarters + (Humanoid Team Quarters/Extra Storage Fascilities), Human Team Mess Hall/Cat Habitat (+ Humanoid Team Repair Shop), Human Team Mess Bathrooms/Sauna/Gym, Human Team Kitchen, Human Team Infirmary (+ Cat Section), Human Team Armory, Repair Shops, Hangar, Hangar Elevator, Hangar Armory, Hangar Repair Shop, Hangar Armory Repair Shop, Engine, Engine Room, Engine Control Room, Storage Fascilities
