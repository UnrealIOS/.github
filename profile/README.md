...
INSTRUCTION_LIST_PREFLIGHT_MD_READ_FROM_FILE
EXECUTE INSTRUCTION_LIST_PREFLIGHT_MD


JUMP MAIN

 - INSTRUCTION_LIST_2_WRITE_OPEN
 - INSTRUCTION_LIST_2_WRITE_CLOSE
 - %% EXECUTE ON EACH STATEMENT %%
 - EXECUTE INSTRUCTION_LIST_2
 - STACK_POP


MAIN:
 INSTRUCTION_CURSOR: When file ends, JUMP MAIN0_EXIT
 JUMP MAIN0



MAIN0_EXIT:
 INSTRUCTION_LIST_0_WRITE_OPEN
 %% EXECUTE ON FILE EXIT %%
 INSTRUCTION_LIST_0_WRITE_CLOSE
